...
public class getPicture extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateTime = findViewById(R.id.day_time);
    ...
    public void save(View view){
        ...
        try {
            ...
            //get text data
            diaryData.datetime = dateTime.getText().toString();
            diaryData.location = location.getText().toString();
            diaryData.context = context.getText().toString();

            //insert to db table
            SQLiteStatement p = db.compileStatement("insert into diary(pic,datetime,location,context,emotion,whether) values(?,?,?,?,?,?);");
            p.bindBlob(1,data);
            p.bindString(2,diaryData.datetime);
            p.bindString(3,diaryData.location);
            p.bindString(4,diaryData.context);
            p.bindString(5,diaryData.emotion);
            p.bindString(6,diaryData.whether);
            p.execute();
